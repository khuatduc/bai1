...
<body>
  ...
  <div class="wrap">
		<div class="header_top">
			<div class="logo">
				<div ><img src="images/logoo.png" style="height: 40px;margin-top: 30px;" alt="" class="img-responsive" /><span>KHUẤT ĐỨC</span></div>
			</div>
			  <div class="header_top_right">
			    <div class="search_box">
				    ...
				    <form action="timkiem.php" method="post">
				    	...
				    	<input type="submit" name="submit1" value="Tìm kiếm">
				    </form>
