<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/theloai/danhsach"><i class="fa fa-dashboard fa-fw"></i> Trang chủ</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="admin/loaisp/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Loại Sản Phẩm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/chitiet/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Sản Phẩm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/chitiet/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/chitiet/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         ...
                         <li>
                            <a href="admin/noidung/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i> Nội Dung<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/noidung/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/noidung/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                          ...
                          <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/muahang/danhsach">Danh Sách</a>
                                </li>
